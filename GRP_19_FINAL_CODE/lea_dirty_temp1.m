function dirty_temp_match = lea_dirty_temp1(glove)
% glove=imread('leather_glove_dirty1.jpg');%main image
[xi,yi,zi]=size(glove);
if zi==1
    glove_img=glove;
else
...
tp1=imread('leather_glove_dirty_temp1.jpg');%part of image
[xt,yt,zt]=size(tp1);
if zt==1
    temp1=tp1;
else
