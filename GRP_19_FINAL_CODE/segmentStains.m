function I_SegmentStains = segmentStains(I,thresholdValue);
...
I_thresh = imbinarize(I_medfilt, str2double(thresholdValue)); %%%55 (latex3); 475(latex1,2); 50-latex4; 63-latex5 ; 82-latex6; 83-7
